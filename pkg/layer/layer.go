...
//}
//
//func (l *Layer) SetConnectionWeightsTo(v float64) (this *Layer) {
//	qn := len(*l)
//	for ni := 0; ni < qn; ni++ { // For every neuron in this layer...
//		n := &(*l)[ni]
//
//		qc := len(n.Connections)
//		for ci := 0; ci < qc; ci++ { // For every connection in this neuron...
//			n.Connections[ci][connection.IndexWeight] = v
//		}
//	}
//	return l
//}
